...
'''
full-shot command:
89.60   90.84   90.42 --kshot 1.0
90.12   90.24   89.10   CUDA_VISIBLE_DEVICES=7 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.9
90.05   89.98   89.81   CUDA_VISIBLE_DEVICES=6 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.8
89.63   89.86   90.625  CUDA_VISIBLE_DEVICES=5 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.7
89.68   89.37   89.23   CUDA_VISIBLE_DEVICES=4 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.6
89.67   89.84   89.15   CUDA_VISIBLE_DEVICES=3 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.5
87.56   89.33   88.63   CUDA_VISIBLE_DEVICES=2 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.4
70.86   87.12   74.47   CUDA_VISIBLE_DEVICES=1 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.3
66.52   72.52   61.39   CUDA_VISIBLE_DEVICES=0 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.2
62.40   63.30   54.83   CUDA_VISIBLE_DEVICES=0 python -u train.entail.from.scratch.py --task_name rte --do_train --do_lower_case --num_train_epochs 10 --train_batch_size 8 --eval_batch_size 64 --learning_rate 1e-6 --max_seq_length 250 --seed 32 --kshot 0.1

90.29, 89.82, 89.95, 90.04, 89.43, 89.55, 88.51, 77.48, 66.81, 60.18
