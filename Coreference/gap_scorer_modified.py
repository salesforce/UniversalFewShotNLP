...
def read_annotations_test(input_list):
    ...
    for tuple in input_list:
        ...
        annotations[example_id].name_b_coref = B_coref
    return annotations
...
def run_scorer(gold_tsv, test_output):
  """Run the scorer.
  ...
  system_annotations = read_annotations_test(test_output)#read_annotations(system_tsv, is_gold=False)
