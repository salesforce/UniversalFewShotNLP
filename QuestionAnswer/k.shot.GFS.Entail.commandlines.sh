...
export BATCHSIZE=10
export TARGETBATCHSIZE=1  #1, 2, 2, 2; 2 is always best
...
CUDA_VISIBLE_DEVICES=0 python -u k.shot.GFS.Entail.py \
    ...
    --kshot $SHOT > log.QA.GFS.Entail.$SHOT.shot.seed.42.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=1 python -u k.shot.GFS.Entail.py \
    ...
    --seed 16 \
    --update_BERT_top_layers $UPDATEBERTLAYERS \
    --kshot $SHOT > log.QA.GFS.Entail.$SHOT.shot.seed.16.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 python -u k.shot.GFS.Entail.py \
    ...
    --seed 32 \
    --update_BERT_top_layers $UPDATEBERTLAYERS \
    --kshot $SHOT > log.QA.GFS.Entail.$SHOT.shot.seed.32.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 python -u k.shot.GFS.Entail.py \
    ...
    --seed 64 \
    --update_BERT_top_layers $UPDATEBERTLAYERS \
    --kshot $SHOT > log.QA.GFS.Entail.$SHOT.shot.seed.64.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=4 python -u k.shot.GFS.Entail.py \
    ...
    --seed 128 \
    --update_BERT_top_layers $UPDATEBERTLAYERS \
    --kshot $SHOT > log.QA.GFS.Entail.$SHOT.shot.seed.128.txt 2>&1 &
