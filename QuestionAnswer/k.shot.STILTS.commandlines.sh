...
CUDA_VISIBLE_DEVICES=0 python -u k.shot.STILTS.py \
    ...
    --seed 42 \
    --kshot $SHOT > log.QA.STILTS.$SHOT.shot.seed.42.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=1 python -u k.shot.STILTS.py \
    ...
    --max_seq_length $MAXLEN \
    --seed 16 \
    --kshot $SHOT > log.QA.STILTS.$SHOT.shot.seed.16.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 python -u k.shot.STILTS.py \
    ...
    --max_seq_length $MAXLEN \
    --seed 32 \
    --kshot $SHOT > log.QA.STILTS.$SHOT.shot.seed.32.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 python -u k.shot.STILTS.py \
    ...
    --max_seq_length $MAXLEN \
    --seed 64 \
    --kshot $SHOT > log.QA.STILTS.$SHOT.shot.seed.64.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=4 python -u k.shot.STILTS.py \
    ...
    --max_seq_length $MAXLEN \
    --seed 128 \
    --kshot $SHOT > log.QA.STILTS.$SHOT.shot.seed.128.txt 2>&1 &
